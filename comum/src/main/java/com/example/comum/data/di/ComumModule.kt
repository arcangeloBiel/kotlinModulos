...
import com.example.comum.data.local.di.RoomModule
...
val commonModule = (commonPresentationModule + commonDomainModule + commonRepositoryModule + commonRemoteModule + RoomModule)
